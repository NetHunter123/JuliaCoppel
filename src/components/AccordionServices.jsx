  ...
  return (
    ...
    >
      <Accordion.Item value="diagnostic">
        <Accordion.Control>РАСКЛАД ТАРО (ДИАГНОСТИКА) 🔍</Accordion.Control>
        <Accordion.Panel>
      ...
      <Accordion.Item value="cemetery_love_spell">
        <Accordion.Control>ЛЮБОВНЫЙ РИТУАЛ «ПОВОРОТ СУДЬБЫ» 💘</Accordion.Control>
        <Accordion.Panel>
      ...
      <Accordion.Item value="amulets">
        ...
        <Accordion.Panel>
          <p className={"mb-[25px]"}>Во время ритуалов и в повседневной жизни я использую магические амулеты, которые помогают преодолеть любые трудности.</p>
          <p className={"mb-[25px]"}>🔸 В моем ассортименте есть множество ценных амулетов из натурального камня, запрограммированных на защиту, удачу, любовь, гармонию, здоровье, финансы.</p>
          <p className={"mb-[25px]"}>🔸 Когда этого требует случай я программирую амулет и привязываю его к Вашей ауре или ауре человека, для которого он будет предназначен (также можно заказать для других людей). В каждом амулете заключены Силы Света.</p>
          <p className={"mb-[25px]"}>Как только вы его получите, вы сразу почувствуете его силу и позитивные вибрации.</p>
          <p >❗️ Амулеты могут отличаться друг от друга. Нет двух одинаковых. Специально для вас я интуитивно выберу самый подходящий из них.</p>
        </Accordion.Panel>
      </Accordion.Item>
      <Accordion.Item value="moneys">
