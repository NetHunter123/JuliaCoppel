      ...
      <div className="container relative ">
        ...
        <div className={"flex w-full relative max-md:flex-col justify-between items-center py-[60px] max-md:py-[30px] z-10"}>
          ...
          <div className="info max-w-[450px] max-w-[500px] max-lg:max-w-full max-md:text-center">
            ...
            <p className={"text-s18 font-[400] mb-[27px]"}>Сегодня ко мне обращаются люди с разными жизненными проблемами - неудачная личная жизнь, родовык проклятия, проблемы самореализации... И я помогаю всем избавиться от оков, обрести счастье и покой, как дома, так и на работе.</p>
